// /industries — Solutions overview page. Editorial hero + a proof
            ...
            {CANONICAL_SLUGS.map((slug, i) => (
              <Reveal key={slug} delay={0.03 + i * 0.02}>
                <Link
                  ...
                  className="group h-full inline-flex flex-col items-start justify-between rounded-2xl bg-paper ring-1 ring-hairline p-4 md:p-5 transition-all duration-500 hover:-translate-y-0.5 hover:ring-hairline-strong hover:shadow-[0_18px_42px_-28px_rgba(0,0,0,0.22)]"
                  style={{ transitionTimingFunction: "cubic-bezier(0.22,1,0.36,1)" }}
                >
                  <span className="text-[10.5px] font-semibold uppercase tracking-[0.18em] text-ink-mute">
                    0{i + 1}
                  </span>
                  <span className="mt-8 md:mt-10 text-[15px] md:text-[16px] font-semibold text-ink group-hover:text-[#E11D2A] transition-colors duration-200">
                    {industryLabels[slug]}
                  </span>
                </Link>
              </Reveal>
