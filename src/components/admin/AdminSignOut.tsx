...
export function AdminSignOut() {
  ...
  return (
    <button
      type="button"
      onClick={handle}
      className="ease-brand inline-flex h-9 items-center justify-center rounded-full border border-hairline-strong bg-paper px-3.5 text-[12px] font-medium text-ink-soft hover:text-ink hover:bg-fog transition-colors duration-200"
    >
      Sign out
    </button>
  );
