      ...
      <div className="min-h-full flex items-center justify-center p-6 md:p-10">
        <div className="w-full max-w-[960px] grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-8 md:gap-10 items-center">
          ...
          >
            ...
            <h1 className="mt-6 text-h1 font-semibold tracking-[-0.022em] leading-[1.05] text-paper">
              Payment successful
            </h1>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 max-w-[440px] mx-auto md:mx-0">
              <button
                type="button"
                onClick={newOrder}
                className="h-12 text-[14px] font-medium rounded-lg bg-brand text-white hover:bg-brand-hover transition-colors"
              >
                Start next order
              </button>
              <button
                ...
                className="h-12 text-[14px] rounded-lg border border-white/10 text-paper/85 hover:bg-white/[0.04] hover:text-paper transition-colors"
              >
                Print receipt
              </button>
            </div>
          ...
          <motion.div
            ...
            className="rounded-lg bg-paper text-ink shadow-[0_30px_60px_rgba(0,0,0,0.55)] p-6 md:p-8 font-mono"
          >
  ...
  const color =
    accent === "amber"
      ...
      : accent === "muted"
        ...
        : "text-paper";
  return (
    <div className="rounded-lg border border-white/8 bg-white/[0.03] p-4 text-left">
